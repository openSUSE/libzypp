...
public:
  ...
  explicit ExplicitMap( param_type mapDefault_r )
  ...
  template <class TInputIterator>
  ExplicitMap(
    TInputIterator first_r, TInputIterator last_r, param_type mapDefault_r )
    : _map( first_r, last_r )
    , _mapDefault( mapDefault_r )
  {
  }
...
public:
  ...
  const_reference getDefault() const { return _mapDefault; }
...
public:
  ...
  void unset( const key_type &key_r ) { _map.erase( key_r ); }

  void setDefault( param_type value_r ) { _mapDefault = value_r; }
...
public:
  ...
  ~TmpSetDefault() { _map.setDefault( _value ); }
