...
class Resolvable : public zypp::base::ReferenceCounted,
                   private zypp::base::NonCopyable
{
...
typename TImpl::ResType::Ptr makeResolvable(
  /*NVRA*/ zypp::base::shared_ptr<TImpl> &impl_r )
{
