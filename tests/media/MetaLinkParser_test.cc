...
{
  Pathname meta3file =
    TESTS_SRC_DIR "/media/data/openSUSE-11.3-NET-i586.iso.metalink";
  Pathname meta4file =
    TESTS_SRC_DIR "/media/data/openSUSE-11.3-NET-i586.iso.meta4";
  ...
  BOOST_CHECK( urls3.begin()->asString() == "http://ftp.uni-kl.de/pub/linux/"
                                            "opensuse/distribution/11.3/iso/"
                                            "openSUSE-11.3-NET-i586.iso" );
  BOOST_CHECK( urls4.begin()->asString() == "http://ftp4.gwdg.de/pub/opensuse/"
                                            "distribution/11.3/iso/"
                                            "openSUSE-11.3-NET-i586.iso" );
