...
BOOST_AUTO_TEST_CASE( flags )
{
  ...
  // enum op enum
  t = ~E::_1;
  BOOST_CHECK_EQUAL( ~t, E::_1 );
  t = E::_1 & E::_2;
  BOOST_CHECK_EQUAL( t, E::_0 );
  t = E::_1 | E::_2;
  BOOST_CHECK_EQUAL( t, E::_3 );
  t = E::_1 ^ E::_2;
  BOOST_CHECK_EQUAL( t, E::_3 );
  ...
  BOOST_CHECK_EQUAL( t, T_6 );
  t = E::_2 ^ T_6;
  BOOST_CHECK_EQUAL( t, E::_4 );

  // TFlags op enum
  t = ~T_7;
  BOOST_CHECK_EQUAL( ~t, T_7 );
  t = T_7 & E::_2;
  BOOST_CHECK_EQUAL( t, E::_2 );
  t = T_7 | E::_2;
  BOOST_CHECK_EQUAL( t, T_7 );
  t = T_7 ^ E::_2;
  BOOST_CHECK_EQUAL( t, E::_5 );
  ...
  t.unsetFlag( E::_2 );
  BOOST_CHECK( t.testFlag( E::_1 ) );
  t.setFlag( E::_1, false );
  BOOST_CHECK( t.testFlag( E::_0 ) ); // succeed as t == 0
  t.setFlag( E::_3, true );
  BOOST_CHECK( t.testFlag( E::_3 ) );
}
