...
BOOST_AUTO_TEST_CASE( pathinfo_checksum_test )
{
  ...
  BOOST_CHECK_EQUAL( checksum( file.path(), "sha1" ),
    "142df4277c326f3549520478c188cab6e3b5d042" );
  BOOST_CHECK_EQUAL(
    checksum( file.path(), "md5" ), "f139a810b84d82d1f29fc53c5e59beae" );
...
BOOST_AUTO_TEST_CASE( test_exchange )
{
  ...
  b = root / "b/p";
  BOOST_CHECK_EQUAL(
    filesystem::exchange( a, b ), 0 ); // ok if both don't exist
