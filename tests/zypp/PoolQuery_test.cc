...
BOOST_AUTO_TEST_CASE( pool_query_001 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 11 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_002 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 5 );
  ...
  BOOST_CHECK(
    std::for_each( q1.begin(), q1.end(), PrintAndCount() )._count == 5 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_003 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 3 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_004 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 1 );
...
BOOST_AUTO_TEST_CASE( pool_query_005 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 6 );
  ...
  BOOST_CHECK(
    std::for_each( q1.begin(), q1.end(), PrintAndCount() )._count == 26 );
...
BOOST_AUTO_TEST_CASE( pool_query_006 )
{
  ...
  BOOST_CHECK(
    std::for_each( q1.begin(), q1.end(), PrintAndCount() )._count == 8 );
...
BOOST_AUTO_TEST_CASE( pool_query_050 )
{
  ...
  BOOST_CHECK_EQUAL(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count, 4 );
...
BOOST_AUTO_TEST_CASE( pool_query_101 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 7 );
  ...
  BOOST_CHECK(
    std::for_each( q2.begin(), q2.end(), PrintAndCount() )._count == 4 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_102 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 23 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_103 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 14 );
  ...
  BOOST_CHECK(
    std::for_each( q1.begin(), q1.end(), PrintAndCount() )._count == 14 );
...
BOOST_AUTO_TEST_CASE( pool_query_104 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 8 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_301 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 42 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_500 )
{
  ...
  // creates: (sun|Thunder)
  BOOST_CHECK(
    std::for_each( q2.begin(), q2.end(), PrintAndCount() )._count == 3 );
  ...
  BOOST_CHECK(
    std::for_each( q3.begin(), q3.end(), PrintAndCount() )._count == 3 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_502 )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 13 );
}
...
BOOST_AUTO_TEST_CASE( pool_query_X )
{
  ...
  BOOST_CHECK(
    std::for_each( q.begin(), q.end(), PrintAndCount() )._count == 0 );
...
BOOST_AUTO_TEST_CASE( pool_query_serialize )
{
  ...
  BOOST_REQUIRE_MESSAGE(
    queries.size() == 4, "Bad count of written/readed queries." );
...
BOOST_AUTO_TEST_CASE( pool_query_equal )
{
  ...
  }
  {
    PoolQuery q;
    q.addDependency(
      sat::SolvAttr::provides, "zypper", Rel::GT, Edition( "1.0" ) );
    v.push_back( q );
  }
  {
    PoolQuery q;
    q.addDependency(
      sat::SolvAttr::provides, "zypper", Rel::GT, Edition( "2.0" ) );
    v.push_back( q );
  }
...
{
  {
    ...
    q.addString( "libzypp" );
    q.addDependency(
      sat::SolvAttr::provides, "FOO" ); // ! finds 'perl(CPAN::InfoObj)' 'foO'
  ...
  }
  {
    ...
    q.addString( "libzypp" );
    q.addDependency(
      sat::SolvAttr::provides, "FOO", Rel::GT, Edition( "5.0" ) );
    std::for_each( q.begin(), q.end(), PrintAndCount() );
    //dumpQ( std::cout, q );
  ...
  }
  {
    ...
    q.setMatchSubstring();
    q.addDependency(
      sat::SolvAttr::provides, "libzypp", Rel::GT, Edition( "5.0" ) );
    q.addAttribute(
      sat::SolvAttr::arch, Arch_i586.asString() ); // OR with arch i585
    std::for_each( q.begin(), q.end(), PrintAndCount() );
    //dumpQ( std::cout, q );
  ...
  }
  {
    ...
    q.addDependency( sat::SolvAttr::provides, "yast2-packagemanager", Rel::GT,
      Edition( "5.0" ), Arch_i586 ); // AND with arch i585
    std::for_each( q.begin(), q.end(), PrintAndCount() );
    //dumpQ( std::cout, q );
  ...
  }
  {
    ...
    q.addDependency( sat::SolvAttr::name, "yast2-packagemanager", Rel::GT,
      Edition( "5.0" ), Arch_i586 ); // AND with arch i585
    std::for_each( q.begin(), q.end(), PrintAndCount() );
    //dumpQ( std::cout, q );
  ...
  }
  {
    ...
    q.setMatchSubstring();
    // libzypp provides yast2-packagemanager...
    q.addDependency( sat::SolvAttr::provides, "yast2-packagemanager",
      Arch_i586 ); // AND with arch i585
    std::for_each( q.begin(), q.end(), PrintAndCount() );
    //dumpQ( std::cout, q );
    BOOST_CHECK_EQUAL( q.size(), 2 );
  }
  {
    ...
    q.setMatchSubstring();
    // but no package named yast2-packagemanager
    q.addDependency( sat::SolvAttr::name, "yast2-packagemanager",
      Arch_i586 ); // AND with arch i585
    std::for_each( q.begin(), q.end(), PrintAndCount() );
    //dumpQ( std::cout, q );
    BOOST_CHECK_EQUAL( q.size(), 0 );
