...
BOOST_AUTO_TEST_CASE( vendor_test1 )
{
  ...
  BOOST_REQUIRE(
    !VendorAttr::instance().equivalent( "opensuse build service", "suse" ) );
  ...
  BOOST_REQUIRE(
    !VendorAttr::instance().equivalent( "opensuse-education", "suse" ) );
  BOOST_REQUIRE(
    !VendorAttr::instance().equivalent( "opensuse-education", "opensuse" ) );
  BOOST_REQUIRE( !VendorAttr::instance().equivalent(
    "opensuse-education", "opensuse build service" ) );
}
