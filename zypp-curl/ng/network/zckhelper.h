...
namespace zyppng {
  ...
  public:
    ...
    struct ZckHandleData;
    using Block = RangeDesc;
    using ZckHandle = std::shared_ptr<ZckHandleData>;
     ...
     */
    static PrepareResult prepareZck ( ZckHandle handleSrc, ZckHandle handleTarget, const zypp::ByteCount &expectedFileSize );
