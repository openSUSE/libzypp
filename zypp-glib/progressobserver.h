...
|                                                                      |
\---------------------------------------------------------------------*/
#ifndef ZYPP_GLIB_PROGRESSOBSERVER_H
#define ZYPP_GLIB_PROGRESSOBSERVER_H
 ...
 */
void zypp_progress_observer_add_subtask(ZyppProgressObserver *self, ZyppProgressObserver *newChild, gfloat weight ) LIBZYPP_GLIB_EXPORT;
 ...
 */
const GList *zypp_progress_observer_get_children ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 */
const gchar *zypp_progress_observer_get_label ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 */
gdouble zypp_progress_observer_get_steps    ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 */
gint zypp_progress_observer_get_base_steps  ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 */
gdouble zypp_progress_observer_get_current  ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 */
gdouble zypp_progress_observer_get_progress ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 *
 */
void zypp_progress_observer_set_label    ( ZyppProgressObserver *self, const gchar *label ) LIBZYPP_GLIB_EXPORT;
 ...
 *
 */
void zypp_progress_observer_set_base_steps    (ZyppProgressObserver *self, gint stepCount ) LIBZYPP_GLIB_EXPORT;
 ...
 */
void zypp_progress_observer_set_current  ( ZyppProgressObserver *self, gdouble value ) LIBZYPP_GLIB_EXPORT;
 ...
 */
void zypp_progress_observer_set_finished ( ZyppProgressObserver *self ) LIBZYPP_GLIB_EXPORT;
 ...
 */
void zypp_progress_observer_inc   ( ZyppProgressObserver *self, gint increase ) LIBZYPP_GLIB_EXPORT;
