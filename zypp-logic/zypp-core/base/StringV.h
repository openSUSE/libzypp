...
namespace zypp
{
  namespace strv
  {
     ...
     *
     * Splitting and trimming of \-escaped strings.
     */
    //@{
    /** Return a copy of \a word_r with all \a special_r chars (and '\') being \-escaped */
     ...
     * // [ "", " \\;a", "", " b", "" ]
     *
     * splitBSEscaped( "; \\;a;; b;", ';', 2 );
     * // [ "", " \\;a", "; b;" ]
     *
     * \note The returned string_views are still \-escaped. Use \ref unBSEscape to turn them into
     * literal strings.
     */
