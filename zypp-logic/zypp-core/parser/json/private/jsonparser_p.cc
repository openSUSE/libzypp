...
namespace zypp::json::detail {
    ...
    | and_then( [&](Parser::Token t) {
      switch ( t._type ) {
        ...
        case Token::TOK_NUMBER_FLOAT:
          return detail::numberFromString( t._token ) | and_then( []( Number n ){ return zyppng::make_expected_success( Value(std::move(n)) ); } );
        case Token::TOK_NUMBER_UINT:
          return detail::uintFromString( t._token )   | and_then( []( UInt n ){ return zyppng::make_expected_success( Value(std::move(n)) ); } );
        case Token::TOK_NUMBER_INT:
          return detail::intFromString( t._token )    | and_then( []( Int n ){ return zyppng::make_expected_success( Value(std::move(n)) ); } );
        case Token::TOK_NULL:
  ...
  zyppng::expected<Value> Parser::finishParseValue( Token begin )
  {
    ...
    switch( begin._type ) {
      ...
      case Token::TOK_NUMBER_FLOAT:
        return detail::numberFromString( begin._token ) | and_then( []( Number n ){ return zyppng::make_expected_success( Value(std::move(n)) ); } );
      case Token::TOK_NUMBER_UINT:
        return detail::uintFromString( begin._token )   | and_then( []( UInt n ){ return zyppng::make_expected_success( Value(std::move(n)) ); } );
      case Token::TOK_NUMBER_INT:
        return detail::intFromString( begin._token )    | and_then( []( Int n ){ return zyppng::make_expected_success( Value(std::move(n)) ); } );
      case Token::TOK_BOOL_TRUE:
        return zyppng::make_expected_success( Value( Bool( true ) ));
      case Token::TOK_BOOL_FALSE:
        return zyppng::make_expected_success( Value( Bool( false ) ));
