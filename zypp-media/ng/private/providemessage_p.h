...
namespace zyppng {
  ...
  class ProviderConfiguration : public std::map<std::string, std::string>, public RpcBaseType
  {
    ZYPP_RPCBASE
    public:
  ...
  class WorkerCaps : public RpcBaseType
  {
    ZYPP_RPCBASE
  public:
  ...
  class ProvideMessage : public RpcBaseType
  {
    ZYPP_RPCBASE
  public:
...
namespace zypp {
  template<> zypp::proto::Configuration* rwcowClone<zypp::proto::Configuration>( const zypp::proto::Configuration * rhs );
  template<> zypp::proto::Capabilities* rwcowClone<zypp::proto::Capabilities>( const zypp::proto::Capabilities * rhs );
  template<> zypp::proto::ProvideMessage* rwcowClone<zypp::proto::ProvideMessage>( const zypp::proto::ProvideMessage * rhs );
}
