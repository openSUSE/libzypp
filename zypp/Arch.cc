...
struct Arch::CompatEntry
{
  ...
  bool isBuiltIn() const { return ( _idBit != CompatBits( 1 ) ); }

  IdString::IdType id() const { return _idStr.id(); }
...
inline std::ostream &operator<<(
  std::ostream &str, const Arch::CompatEntry &obj )
{
  ...
  return str << str::form( "%-15s ", obj._archStr.c_str() )
             << str::numstring( bitnum, 2 ) << ' ' << obj._compatBits << ' '
             << obj._compatBits.value();
}

/** \relates Arch::CompatEntry */
inline bool operator==(
  const Arch::CompatEntry &lhs, const Arch::CompatEntry &rhs )
{
...
#define DEF_BUILTIN( A )                                                       \
  namespace                                                                    \
  {                                                                            \
  static inline const IdString &a_##A()                                        \
  {                                                                            \
    static IdString _str( #A );                                                \
    return _str;                                                               \
  }                                                                            \
  }                                                                            \
...
struct ArchCompatSet : private base::NonCopyable
{
  ...
  const_iterator begin() const { return _compatSet.begin(); }

  const_iterator end() const { return _compatSet.end(); }
  ...
  std::ostream &dumpOn( std::ostream &str ) const
  {
    ...
    for_( it, ov.begin(), ov.end() ) { str << endl << ' ' << *it; }
    return str;
  }
...
private:
  ...
  ArchCompatSet()
  {
    ...
    defCompatibleWith(
      a_athlon(), a_noarch(), a_i386(), a_i486(), a_i586(), a_i686() );
    defCompatibleWith( a_x86_64(), a_noarch(), a_i386(), a_i486(), a_i586(),
      a_i686(), a_athlon() );

    defCompatibleWith(
      a_pentium3(), a_noarch(), a_i386(), a_i486(), a_i586(), a_i686() );
    defCompatibleWith( a_pentium4(), a_noarch(), a_i386(), a_i486(), a_i586(),
      a_i686(), a_pentium3() );

    defCompatibleWith(
      a_ia64(), a_noarch(), a_i386(), a_i486(), a_i586(), a_i686() );
    //
    ...
    defCompatibleWith(
      a_alphapca56(), a_noarch(), a_alpha(), a_alphaev5(), a_alphaev56() );
    defCompatibleWith( a_alphaev6(), a_noarch(), a_alpha(), a_alphaev5(),
      a_alphaev56(), a_alphapca56() );
    defCompatibleWith( a_alphaev67(), a_noarch(), a_alpha(), a_alphaev5(),
      a_alphaev56(), a_alphapca56(), a_alphaev6() );
    //
    ...
    defCompatibleWith(
      a_sparcv9v(), a_noarch(), a_sparc(), a_sparcv8(), a_sparcv9() );
    //
    defCompatibleWith(
      a_sparc64(), a_noarch(), a_sparc(), a_sparcv8(), a_sparcv9() );
    defCompatibleWith( a_sparc64v(), a_noarch(), a_sparc(), a_sparcv8(),
      a_sparcv9(), a_sparcv9v(), a_sparc64() );
    //
    ...
    defCompatibleWith(
      a_armv5l(), a_noarch(), a_armv3l(), a_armv4l(), a_armv4tl() );
    defCompatibleWith( a_armv5tl(), a_noarch(), a_armv3l(), a_armv4l(),
      a_armv4tl(), a_armv5l() );
    defCompatibleWith( a_armv5tel(), a_noarch(), a_armv3l(), a_armv4l(),
      a_armv4tl(), a_armv5l(), a_armv5tl() );
    defCompatibleWith( a_armv5tejl(), a_noarch(), a_armv3l(), a_armv4l(),
      a_armv4tl(), a_armv5l(), a_armv5tl(), a_armv5tel() );
    defCompatibleWith( a_armv6l(), a_noarch(), a_armv3l(), a_armv4l(),
      a_armv4tl(), a_armv5l(), a_armv5tl(), a_armv5tel(), a_armv5tejl() );
    defCompatibleWith( a_armv7l(), a_noarch(), a_armv3l(), a_armv4l(),
      a_armv4tl(), a_armv5l(), a_armv5tl(), a_armv5tel(), a_armv5tejl(),
      a_armv6l() );
    ...
    defCompatibleWith(
      a_armv7nhl(), a_noarch(), a_armv7hnl(), a_armv7hl(), a_armv6hl() );

    /*?*/ defCompatibleWith( a_armv7thl(), a_noarch(), a_armv7hl() );
    /*?*/ defCompatibleWith(
      a_armv7tnhl(), a_noarch(), a_armv7hl(), a_armv7nhl(), a_armv7thl() );
...
private:
  ...
  CompatBits::IntT nextIdBit() const
  {
    if ( CompatBits::size == _compatSet.size() )
    {
      ...
      INT << "Need more than " << CompatBits::size
          << " bits to encode architectures." << endl;
  ...
  /** Initialize builtin Archs and set _compatBits.
      */
  void defCompatibleWith( IdString targetArch_r, IdString arch0_r,
    IdString arch1_r = IdString(), IdString arch2_r = IdString(),
    IdString arch3_r = IdString(), IdString arch4_r = IdString(),
    IdString arch5_r = IdString(), IdString arch6_r = IdString(),
    IdString arch7_r = IdString(), IdString arch8_r = IdString(),
...
#define SETARG( N )                                                            \
  if ( arch##N##_r.empty() )                                                   \
    return;                                                                    \
  target.addCompatBit( assertCompatSetEntry( arch##N##_r )._idBit )
    SETARG( 1 );
    SETARG( 2 );
    SETARG( 3 );
    SETARG( 4 );
...
//
IdString Arch::idStr() const { return _entry->_idStr; }
...
//
const std::string &Arch::asString() const { return _entry->_archStr; }
...
//	METHOD TYPE : bool
//
bool Arch::isBuiltIn() const { return _entry->isBuiltIn(); }
