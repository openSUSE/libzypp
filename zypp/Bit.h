...
public:
  ...
  explicit operator bool() const { return _value != (TInt)0; }
...
public:
  ...
  TInt value() const { return _value; }
  ...
  std::string asString() const { return bit::asString( _value, '_' ); }
  ...
  {
    _value =
      ( _value & TRange::Mask::inverted ) | ( rhs & TRange::Mask::value );
    return *this;
  }
  BitField &assign( TInt rhs )
  {
  ...
  {
    return ( _value & TRange::Mask::value ) == ( rhs & TRange::Mask::value );
  }
  bool isEqual( TInt rhs ) const { return _value == rhs; }
...
public:
  ...
  bool test( TInt rhs ) const { return ( _value & rhs ) == rhs; }
  ...
  bool testAnyOf( TInt rhs ) const { return ( _value & rhs ); }
...
public:
  ...
  BitField operator~() const { return ~_value; }
...
/** \relates BitField */
template <class TInt>
inline BitField<TInt> operator&(
  const BitField<TInt> &lhs, const BitField<TInt> &rhs )
{
