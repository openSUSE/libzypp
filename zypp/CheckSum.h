...
{ /////////////////////////////////////////////////////////////////
  ...
  struct ZYPP_EXPORT CheckSumException : public Exception
  {
  ...
  ZYPP_EXPORT std::ostream & operator<<( std::ostream & str, const CheckSum & obj );

  /** \relates CheckSum */
  ZYPP_EXPORT bool operator==( const CheckSum & lhs, const CheckSum & rhs );
