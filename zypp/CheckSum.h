...
public:
  ...
  {
    return CheckSum( sha224Type(), checksum );
  }
  ...
  {
    return CheckSum( sha384Type(), checksum );
  }
  static CheckSum sha512( const std::string &checksum )
  {
    return CheckSum( sha512Type(), checksum );
  }
  //@}
  ...
  {
    return CheckSum( sha224Type(), input_r );
  }
  ...
  {
    return CheckSum( sha384Type(), input_r );
  }
  static CheckSum sha512( std::istream &input_r )
  {
    return CheckSum( sha512Type(), input_r );
  }
