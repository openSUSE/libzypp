...
const HistoryActionID HistoryActionID::REPO_REMOVE(
  HistoryActionID::REPO_REMOVE_e );
const HistoryActionID HistoryActionID::REPO_CHANGE_ALIAS(
  HistoryActionID::REPO_CHANGE_ALIAS_e );
const HistoryActionID HistoryActionID::REPO_CHANGE_URL(
  HistoryActionID::REPO_CHANGE_URL_e );
const HistoryActionID HistoryActionID::STAMP_COMMAND(
  HistoryActionID::STAMP_COMMAND_e );
...
public:
  ...
  Impl( FieldVector &fields_r, HistoryActionID action_r, size_type expect_r )
  {
    ...
    {
      ZYPP_THROW(
        ParseException( str::form( "Bad action id. Got %s, expected %s.",
          _action.asString().c_str(), action_r.asString().c_str() ) ) );
    }
    _field.swap( fields_r );
  ...
  void _checkFields( const FieldVector &fields_r, size_type expect_r )
  {
    ...
    if ( fields_r.size() < expect_r )
    {
      ZYPP_THROW( ParseException(
        str::form( "Bad number of fields. Got %zd, expected at least %zd.",
          fields_r.size(), expect_r ) ) );
    }
    try
    {
...
HistoryLogData::Ptr HistoryLogData::create( FieldVector &fields_r )
{
  if ( fields_r.size() >= 2 )
  {
    ...
    {
#define OUTS( E, T )                                                           \
  case HistoryActionID::E:                                                     \
    return Ptr( new T( fields_r ) );                                           \
    break;
...
bool HistoryLogData::empty() const { return _pimpl->_field.empty(); }
...
Date HistoryLogData::date() const { return _pimpl->_date; }

HistoryActionID HistoryLogData::action() const { return _pimpl->_action; }
...
std::string HistoryLogDataInstall::name() const
{
  return optionalAt( NAME_INDEX );
}
Edition HistoryLogDataInstall::edition() const
{
  return Edition( optionalAt( EDITION_INDEX ) );
}
Arch HistoryLogDataInstall::arch() const
{
  return Arch( optionalAt( ARCH_INDEX ) );
}
std::string HistoryLogDataInstall::reqby() const
{
  return optionalAt( REQBY_INDEX );
}
std::string HistoryLogDataInstall::repoAlias() const
{
  return optionalAt( REPOALIAS_INDEX );
}
CheckSum HistoryLogDataInstall::checksum() const
{
  return optionalAt( CHEKSUM_INDEX );
}
std::string HistoryLogDataInstall::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
...
std::string HistoryLogDataRemove::name() const
{
  return optionalAt( NAME_INDEX );
}
Edition HistoryLogDataRemove::edition() const
{
  return Edition( optionalAt( EDITION_INDEX ) );
}
Arch HistoryLogDataRemove::arch() const
{
  return Arch( optionalAt( ARCH_INDEX ) );
}
std::string HistoryLogDataRemove::reqby() const
{
  return optionalAt( REQBY_INDEX );
}
std::string HistoryLogDataRemove::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
...
std::string HistoryLogDataRepoAdd::alias() const
{
  return optionalAt( ALIAS_INDEX );
}
Url HistoryLogDataRepoAdd::url() const { return optionalAt( URL_INDEX ); }
std::string HistoryLogDataRepoAdd::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
...
std::string HistoryLogDataRepoRemove::alias() const
{
  return optionalAt( ALIAS_INDEX );
}
std::string HistoryLogDataRepoRemove::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
...
///////////////////////////////////////////////////////////////////
HistoryLogDataRepoAliasChange::HistoryLogDataRepoAliasChange(
  FieldVector &fields_r )
  : HistoryLogData( fields_r )
{
}
std::string HistoryLogDataRepoAliasChange::oldAlias() const
{
  return optionalAt( OLDALIAS_INDEX );
}
std::string HistoryLogDataRepoAliasChange::newAlias() const
{
  return optionalAt( NEWALIAS_INDEX );
}
std::string HistoryLogDataRepoAliasChange::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
...
///////////////////////////////////////////////////////////////////
HistoryLogDataRepoUrlChange::HistoryLogDataRepoUrlChange(
  FieldVector &fields_r )
  : HistoryLogData( fields_r )
{
}
std::string HistoryLogDataRepoUrlChange::alias() const
{
  return optionalAt( ALIAS_INDEX );
}
Url HistoryLogDataRepoUrlChange::newUrl() const
{
  return optionalAt( NEWURL_INDEX );
}
std::string HistoryLogDataRepoUrlChange::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
...
std::string HistoryLogDataStampCommand::executedBy() const
{
  return optionalAt( USER_INDEX );
}
std::string HistoryLogDataStampCommand::command() const
{
  return optionalAt( COMMAND_INDEX );
}
std::string HistoryLogDataStampCommand::userdata() const
{
  return optionalAt( USERDATA_INDEX );
}
