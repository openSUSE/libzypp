...
class OnMediaLocation
{
  friend std::ostream &operator<<(
    std::ostream &str, const OnMediaLocation &obj );
...
public:
  ...
  OnMediaLocation &setLocation(
    const Pathname &val_r, unsigned mediaNumber_r = 1 )
  {
    _filename = val_r;
    _medianr = mediaNumber_r;
    return *this;
  }
...
public:
  ...
  {
    if ( !prefix_r.emptyOrRoot() )
      changeFilename( prefix_r / filename() );
    return *this;
  }
