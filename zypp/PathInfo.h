  ...
  */
  ...
  { /////////////////////////////////////////////////////////////////
    ...
    */
    ...
    extern ZYPP_EXPORT std::ostream & operator<<( std::ostream & str, FileType obj );
    ...
    extern ZYPP_EXPORT std::ostream & operator<<( std::ostream & str, const StatMode & obj );
    ...
    extern ZYPP_EXPORT std::ostream & operator<<( std::ostream & str, const PathInfo & obj );
     ...
     **/
    ZYPP_EXPORT int mkdir( const Pathname & path, unsigned mode = 0755 );
     ...
     * @return 0 on success, errno on failure
     **/
    ZYPP_EXPORT int assert_dir( const Pathname & path, unsigned mode = 0755 );
     ...
     * @return 0 on success, errno on failure
     **/
    ZYPP_EXPORT int rmdir( const Pathname & path );
     ...
     **/
    ZYPP_EXPORT int recursive_rmdir( const Pathname & path );
     ...
     * commands return value.
     **/
    ZYPP_EXPORT int clean_dir( const Pathname & path );
     ...
     **/
    ZYPP_EXPORT int copy_dir( const Pathname & srcpath, const Pathname & destpath );
     ...
     * return value.
     */
    ZYPP_EXPORT int copy_dir_content( const Pathname & srcpath, const Pathname & destpath);

    /**
     * Convenience returning <tt>StrMatcher( "[^.]*", Match::GLOB )</tt>
     * \see \ref dirForEach
     */
    ZYPP_EXPORT const StrMatcher & matchNoDots();
     ...
     */
    ZYPP_EXPORT int dirForEach( const Pathname & dir_r, function<bool(const Pathname &, const char *const)> fnc_r );
     ...
     * \endcode
     */
    ZYPP_EXPORT int dirForEach( const Pathname & dir_r, const StrMatcher & matcher_r, function<bool(const Pathname &, const char *const)> fnc_r );
    ...
    ZYPP_EXPORT int readdir( std::list<std::string> & retlist,
    ...
    ZYPP_EXPORT int readdir( std::list<Pathname> & retlist,
                 const Pathname & path, bool dots = true );

    /** Listentry returned by readdir. */
    struct ZYPP_EXPORT DirEntry {
      std::string name;
      FileType    type;
     ...
     * @return 0 on success, errno on failure.
     **/
    ZYPP_EXPORT int readdir( DirContent & retlist, const Pathname & path,
     ...
     */
    ZYPP_EXPORT int is_empty_dir(const Pathname & path);
     ...
     * @return 0 on success, errno on failure
     **/
    ZYPP_EXPORT int assert_file( const Pathname & path, unsigned mode = 0644 );
     ...
     * \see man utime
     */
    ZYPP_EXPORT int touch (const Pathname & path);
     ...
     * @return 0 on success, errno on failure
     **/
    ZYPP_EXPORT int unlink( const Pathname & path );
     ...
     * @return 0 on success, errno on failure
     **/
    ZYPP_EXPORT int rename( const Pathname & oldpath, const Pathname & newpath );
     ...
     * @return 0 on success, errno on failure
     */
    ZYPP_EXPORT int exchange( const Pathname & lpath, const Pathname & rpath );
     ...
     **/
    ZYPP_EXPORT int copy( const Pathname & file, const Pathname & dest );
     ...
     * @return 0 on success, errno on failure.
     **/
    ZYPP_EXPORT int symlink( const Pathname & oldpath, const Pathname & newpath );
     ...
     * @return 0 on success, errno on failure.
     **/
    ZYPP_EXPORT int hardlink( const Pathname & oldpath, const Pathname & newpath );
     ...
     * @return 0 on success, errno on failure.
     */
    ZYPP_EXPORT int hardlinkCopy( const Pathname & oldpath, const Pathname & newpath );
     ...
     * @return 0 on success, errno on failure.
     */
    ZYPP_EXPORT int readlink( const Pathname & symlink_r, Pathname & target_r );
     ...
     */
    ZYPP_EXPORT Pathname expandlink( const Pathname & path_r );
     ...
     **/
    ZYPP_EXPORT int copy_file2dir( const Pathname & file, const Pathname & dest );
    //@}
    ...
    */
     ...
     **/
    ZYPP_EXPORT std::string md5sum( const Pathname & file );
     ...
     **/
    ZYPP_EXPORT std::string sha1sum( const Pathname & file );
    //@}
     ...
     **/
    ZYPP_EXPORT std::string checksum( const Pathname & file, const std::string &algorithm );
     ...
     **/
    ZYPP_EXPORT bool is_checksum( const Pathname & file, const CheckSum &checksum );
     ...
     * @return 0 on success, errno on failure
     **/
    ZYPP_EXPORT int chmod( const Pathname & path, mode_t mode );
     ...
     * @return 0 on success, errno on failure
     */
    ZYPP_EXPORT int addmod( const Pathname & path, mode_t mode );
     ...
     * @return 0 on success, errno on failure
     */
    ZYPP_EXPORT int delmod( const Pathname & path, mode_t mode );
    //@}
     ...
     **/
    enum ZYPP_EXPORT ZIP_TYPE { ZT_NONE, ZT_GZ, ZT_BZ2 };

    ZYPP_EXPORT ZIP_TYPE zipType( const Pathname & file );
     ...
     **/
    ZYPP_EXPORT int erase( const Pathname & path );
     ...
     **/
    ZYPP_EXPORT ByteCount df( const Pathname & path );
