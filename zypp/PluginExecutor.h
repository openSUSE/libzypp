...
namespace zypp
{
  ...
  /// \ingroup g_RAII
  ///////////////////////////////////////////////////////////////////
  class PluginExecutor : private base::SafeBool<PluginExecutor>
  {
    ...
    public:
      ...
      using base::SafeBool<PluginExecutor>::operator bool_type;
#endif
    ...
    private:
#ifndef SWIG // Swig treats it as syntax error
      friend base::SafeBool<PluginExecutor>::operator bool_type() const;
#endif
      bool boolTest() const
      { return !empty(); }
