...
bool overlaps( Rel lhs, Rel rhs, int cmp )
{
  ...
  if ( lhs == Rel::NE )
  {
    ...
    {
      // lhs < rhs
      return ( rhs == Rel::GE || rhs == Rel::EQ );
    }
    else if ( cmp > 0 )
    {
      // lhs > rhs
      return ( rhs == Rel::LT || rhs == Rel::EQ );
    }
    else
    {
      //lhs == rhs
      return ( rhs == Rel::GT || rhs == Rel::LT );
    }
  }
  ...
  if ( rhs == Rel::NE )
  {
    ...
    {
      // lhs < rhs
      return ( lhs == Rel::LE || lhs == Rel::EQ );
    }
    else if ( cmp > 0 )
    {
      // lhs > rhs
      return ( lhs == Rel::GT || lhs == Rel::EQ );
    }
    else
    {
      //lhs == rhs
      return ( lhs == Rel::GT || lhs == Rel::LT );
    }
  }
  ...
  if ( cmp < 0 )
  {
    ...
    return (
      lhs == Rel::GT || lhs == Rel::GE || rhs == Rel::LT || rhs == Rel::LE );
  }
  ...
  if ( cmp > 0 )
  {
    ...
    return (
      lhs == Rel::LT || lhs == Rel::LE || rhs == Rel::GT || rhs == Rel::GE );
  }
