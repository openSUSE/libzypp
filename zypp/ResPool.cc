...
ResPoolProxy ResPool::proxy() const { return _pimpl->proxy( *this ); }

Resolver &ResPool::resolver() const { return *getZYpp()->resolver(); }

const SerialNumber &ResPool::serial() const { return _pimpl->serial(); }

bool ResPool::empty() const { return _pimpl->empty(); }

ResPool::size_type ResPool::size() const { return _pimpl->size(); }
