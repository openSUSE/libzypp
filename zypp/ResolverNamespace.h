...
{
  return IdString( obj == ResolverNamespace::language
                     ? sat::detail::namespaceLanguage
                     : obj == ResolverNamespace::modalias
                         ? sat::detail::namespaceModalias
                         : obj == ResolverNamespace::filesystem
                             ? sat::detail::namespaceFilesystem
                             : sat::detail::noId );
}
