...
//
inline bool solutionInList( const ProblemSolutionList &solutions_r,
...
const std::string &ResolverProblem::details() const { return _pimpl->_details; }
...
{
  if ( !solutionInList( _pimpl->_solutions,
         solution ) ) // bsc#985674: filter duplicate solutions
  {
    if ( inFront )
    {
