...
std::string asUserStringDescription( VendorSupportOption opt )
{
  switch ( opt )
  {
    ...
    case VendorSupportUnsupported:
      ...
      break;
    case VendorSupportLevel1:
      return _( "Problem determination, which means technical support designed "
                "to provide compatibility information, installation "
                "assistance, usage support, on-going maintenance and basic "
                "troubleshooting. Level 1 Support is not intended to correct "
                "product defect errors." );
      break;
    case VendorSupportLevel2:
      return _( "Problem isolation, which means technical support designed to "
                "duplicate customer problems, isolate problem area and provide "
                "resolution for problems not resolved by Level 1 Support." );
      break;
    case VendorSupportLevel3:
      return _( "Problem resolution, which means technical support designed to "
                "resolve complex problems by engaging engineering in "
                "resolution of product defects which have been identified by "
                "Level 2 Support." );
      break;
    case VendorSupportACC:
      return _(
