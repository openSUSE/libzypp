...
public:
  ...
  void resetTextLocale() { setTextLocale( defaultTextLocale() ); }
...
public:
  ...
  TriBool repoGpgCheck()
    const; ///< Check repo matadata signatures (indeterminate - according to gpgcheck)
  TriBool pkgGpgCheck()
    const; ///< Check rpm package signatures (indeterminate - according to gpgcheck)
