...
struct ProgressReport : public callback::ReportBase
{
  ...
  virtual bool progress( const ProgressData & /*task*/ ) { return true; }
...
struct DownloadResolvableReport : public callback::ReportBase
{
  ...
  /** Hint that package is available in the local cache (no download needed).
       ...
       */
  virtual void infoInCache(
    Resolvable::constPtr res_r, const Pathname &localfile_r )
  {
  }
  ...
  virtual void startDeltaDownload(
    const Pathname & /*filename*/, const ByteCount & /*downloadsize*/ )
  {
  }
  ...
  virtual bool progress(
    int /*value*/, Resolvable::constPtr /*resolvable_ptr*/ )
  {
    return true;
  }
...
struct ProbeRepoReport : public callback::ReportBase
{
  ...
  virtual void finish(
    const Url & /*url*/, Error /*error*/, const std::string & /*reason*/ )
  {
  }

  virtual bool progress( const Url & /*url*/, int /*value*/ ) { return true; }

  virtual Action problem(
    const Url & /*url*/, Error /*error*/, const std::string & /*description*/ )
  {
    return ABORT;
  }
};
...
struct RepoCreateReport : public callback::ReportBase
{
  ...
  virtual bool progress( int /*value*/ ) { return true; }

  virtual Action problem( const zypp::Url & /*url*/
    ,
    Error /*error*/
    ,
    const std::string & /*description*/ )
  ...
  virtual void finish( const zypp::Url & /*url*/
    ,
    Error /*error*/
    ,
    const std::string & /*reason*/ )
...
struct RepoReport : public callback::ReportBase
{
  ...
  virtual Action problem( Repository /*source*/
    ,
    Error /*error*/
    ,
    const std::string & /*description*/ )
  ...
  virtual void finish( Repository /*source*/
    ,
...
struct MediaChangeReport : public callback::ReportBase
{
  ...
  /**
       ...
       */
  virtual Action requestMedia( Url & /* url (I/O parameter) */
    ,
    unsigned /*mediumNr*/
    ,
...
struct DownloadProgressReport : public callback::ReportBase
{
  ...
  virtual bool progress( int /*value*/, const Url & /*file*/,
    double dbps_avg = -1, double dbps_current = -1 )
  {
    return true;
  }
  ...
  virtual void finish( const Url & /*file*/
    ,
    Error /*error*/
    ,
    const std::string & /*reason*/
...
struct AuthenticationReport : public callback::ReportBase
{
  /**
       ...
       *         false otherwise
       */
  virtual bool prompt( const Url & /* url */, const std::string & /* msg */,
    AuthData & /* auth_data */ )
  {
    return false;
  }
...
struct PatchMessageReport : public callback::ReportBase
{
  /** Display \c patch->message().
      ...
      */
  virtual bool show( Patch::constPtr & /*patch*/ ) { return true; }
};
...
struct PatchScriptReport : public callback::ReportBase
{
  ...
  /** Start executing the script provided by package.
      */
  virtual void start(
    const Package::constPtr & /*package*/, const Pathname & /*script path*/ )
  {
  }
  /** Progress provides the script output. If the script is quiet,
      ...
      */
  virtual bool progress(
    Notify /*OUTPUT or PING*/, const std::string & /*output*/ = std::string() )
  {
    return true;
  }
  /** Report error. */
...
struct FindFileConflictstReport : public callback::ReportBase
{
  /**
       ...
       */
  virtual bool start( const ProgressData &progress_r ) { return true; }
  ...
  /**
       ...
       */
  virtual bool progress(
    const ProgressData &progress_r, const sat::Queue &noFilelist_r )
  {
    return true;
  }
  ...
  /**
       ...
       * \return \c true to continue, \c false upon user abort request.
       */
  virtual bool result( const ProgressData &progress_r,
    const sat::Queue &noFilelist_r, const sat::FileConflicts &conflicts_r )
  {
    return true;
  }
};
...
struct InstallResolvableReport : public callback::ReportBase
{
  ...
  virtual Action problem( Resolvable::constPtr /*resolvable*/
    ,
    Error /*error*/
    ,
    const std::string & /*description*/
...
struct RebuildDBReport : public callback::ReportBase
{
  ...
  virtual bool progress( int /*value*/, Pathname /*path*/ ) { return true; }

  virtual Action problem( Pathname /*path*/
    ,
    Error /*error*/
    ,
    const std::string & /*description*/
  ...
  virtual void finish( Pathname /*path*/
    ,
    Error /*error*/
    ,
    const std::string & /*reason*/
...
struct CleanEmptyLocksReport : public callback::ReportBase
{
  ...
  /**
     ...
     * \return action
     */
  virtual Action execute( const PoolQuery & /*error*/
    )
  {
    return DELETE;
  }
  ...
  /**
       * cleaning is done
       */
  virtual void finish( Error /*error*/
    )
  {
  }
};
...
struct SavingLocksReport : public callback::ReportBase
{
  ...
  /**
     ...
     */
  virtual Action conflict( const PoolQuery &, /**< problematic query*/
    ConflictState )
  {
    return DELETE;
  }
...
public:
  ...
  virtual bool message(
    MsgType type_r, const std::string &msg_r, const UserData &userData_r ) const
  {
    return true;
  }
  ...
  static bool debug(
    const std::string &msg_r, const UserData &userData_r = UserData() )
  {
