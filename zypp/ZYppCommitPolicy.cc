...
bool ZYppCommitPolicy::dryRun() const { return _pimpl->_dryRun; }
...
ZYppCommitPolicy &ZYppCommitPolicy::rpmInstFlags(
...
{
  _pimpl->_rpmInstFlags.setFlag( target::rpm::RPMINST_NOSIGNATURE, yesNo_r );
  return *this;
}

ZYppCommitPolicy &ZYppCommitPolicy::rpmExcludeDocs( bool yesNo_r )
{
  _pimpl->_rpmInstFlags.setFlag( target::rpm::RPMINST_EXCLUDEDOCS, yesNo_r );
  return *this;
}
