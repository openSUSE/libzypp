...
{ /////////////////////////////////////////////////////////////////
  ...
  class ZYPP_EXPORT ZYppFactoryException : public Exception
  {
  public:
  ...
  */
  ...
  ZYPP_EXPORT std::ostream & operator<<( std::ostream & str, const ZYppFactory & obj );
