...
inline int invokeOnEach(
  TIterator begin_r, TIterator end_r, TFilter filter_r, TFunction fnc_r )
{
  int cnt = 0;
...
inline int invokeOnEach( TIterator begin_r, TIterator end_r, TFunction fnc_r )
{
  int cnt = 0;
  for ( TIterator it = begin_r; it != end_r; ++it )
  {
