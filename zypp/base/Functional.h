...
struct FunctorRef0
{
  ...
  res_type operator()() const { return _f(); }
...
struct FunctorRef1 : public std::unary_function<arg1_type, res_type>
{
  ...
  res_type operator()( arg1_type a1 ) const { return _f( a1 ); }
  ...
  : public functor_detail::FunctorRef2<TFunctor, res_type, arg1_type, arg2_type>
{
  FunctorRef( TFunctor &f_r )
    : functor_detail::FunctorRef2<TFunctor, res_type, arg1_type, arg2_type>(
        f_r )
  {
  }
};
...
inline True true_c() { return True(); }
...
inline False false_c() { return False(); }
...
/** Convenience function for creating a Or from two conditions
    ...
    */
template <class TACondition, class TBCondition>
inline Or<TACondition, TBCondition> or_c(
  TACondition conda_r, TBCondition condb_r )
{
...
/** Convenience function for creating a Chain from two conditions
    ...
    */
template <class TACondition, class TBCondition>
inline Chain<TACondition, TBCondition> chain(
  TACondition conda_r, TBCondition condb_r )
{
