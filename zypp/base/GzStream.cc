...
//
fgzstreambuf *fgzstreambuf::open(
...
//
fgzstreambuf::int_type fgzstreambuf::overflow( int_type c )
{
...
//	METHOD TYPE : fgzstreambuf::int_type
//
fgzstreambuf::int_type fgzstreambuf::underflow()
{
  int_type ret = traits_type::eof();
  if ( inReadMode() )
  {
...
//
std::streamsize fgzstreambuf::zReadTo(
...
//	METHOD TYPE : bool
//
bool fgzstreambuf::zWriteFrom( const char *buffer_r, std::streamsize count_r )
{
  int written = 0;
  if ( count_r )
  {
...
//
fgzstreambuf::pos_type fgzstreambuf::zSeekTo(
  off_type off_r, std::ios_base::seekdir way_r )
{
...
//	METHOD TYPE : fgzstreambuf::pos_type
//
fgzstreambuf::pos_type fgzstreambuf::zTell()
{
...
//	METHOD TYPE : fgzstreambuf::pos_type
//
fgzstreambuf::pos_type fgzstreambuf::seekTo(
  off_type off_r, std::ios_base::seekdir way_r )
{
        ...
        else
        {
          ...
          if ( way_r == std::ios_base::beg )
          {
            if ( zeback <= zngptr && zngptr <= zegptr )
            {
              ...
              setg( eback(), eback() + ( zngptr - zeback ), egptr() );
              ret = pos_type( zngptr );
            }
            else
            {
...
fgzstreambuf::pos_type fgzstreambuf::compressed_tell() const
{
