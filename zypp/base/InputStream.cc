...
//	METHOD TYPE : Constructor
//
InputStream::InputStream( std::istream &stream_r, const std::string &name_r )
...
//	METHOD TYPE : Constructor
//
InputStream::InputStream( const Pathname &file_r, const std::string &name_r )
  : _path( file_r )
  , _stream( new ifgzstream( _path.asString().c_str() ) )
  , _name( name_r )
  , _size( _heplerInitSize( _path ) )
...
//	METHOD TYPE : Constructor
//
InputStream::InputStream( const std::string &file_r, const std::string &name_r )
  : _path( file_r )
  , _stream( new ifgzstream( _path.asString().c_str() ) )
  , _name( name_r )
  , _size( _heplerInitSize( _path ) )
...
//	METHOD TYPE : Constructor
//
InputStream::InputStream( const char *file_r, const std::string &name_r )
  : _path( file_r )
  , _stream( new ifgzstream( _path.asString().c_str() ) )
  , _name( name_r )
  , _size( _heplerInitSize( _path ) )
