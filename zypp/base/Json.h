...
{
// JSN Keywords
inline static const std::string &nullJSON()
{
  static const std::string _s( "null" );
  return _s;
}
inline static const std::string &trueJSON()
{
  static const std::string _s( "true" );
  return _s;
}
inline static const std::string &falseJSON()
{
  static const std::string _s( "false" );
  return _s;
}
...
// bool
inline std::string toJSON( bool val_r )
{
  return val_r ? trueJSON() : falseJSON();
}
inline std::string toJSON( const void *val_r )
{
  return val_r ? trueJSON() : falseJSON();
}
...
inline std::string toJSON( unsigned short val_r )
{
  return str::numstring( val_r );
}
...
inline std::string toJSON( unsigned long val_r )
{
  return str::numstring( val_r );
}
inline std::string toJSON( long long val_r ) { return str::numstring( val_r ); }
inline std::string toJSON( unsigned long long val_r )
{
  return str::numstring( val_r );
}

// strings
inline std::string toJSON( const char val_r )
{
  return detail::strEncode( std::string( 1, val_r ) );
}
inline std::string toJSON( const char *val_r )
{
  return val_r ? detail::strEncode( val_r ) : nullJSON();
}
inline std::string toJSON( const std::string &val_r )
{
  return detail::strEncode( val_r );
}
...
struct Value
{
  ...
  /** JSON representation */
  const std::string &asJSON() const { return _data; }

  /** String representation */
  const std::string &asString() const { return asJSON(); }

  /** Stream output */
  std::ostream &dumpOn( std::ostream &str ) const { return str << _data; }
...
struct Array
{
  ...
  void add( const Value &val_r ) { _data.push_back( val_r.asJSON() ); }
  ...
  /** JSON representation */
  std::string asJSON() const { return str::Str() << *this; }

  /** String representation */
  std::string asString() const { return asJSON(); }
  ...
  std::ostream &dumpOn( std::ostream &str ) const
  {
    if ( _data.empty() )
      return str << "[]";
    str << '[' << *_data.begin();
    for_( val, ++_data.begin(), _data.end() ) str << ", " << *val;
    return str << ']';
  }
...
struct Object
{
  ...
  std::ostream &dumpOn( std::ostream &str ) const
  {
    ...
    for_( val, ++_data.begin(), _data.end() ) dumpOn( str << ',' << endl, val );
    return str << endl << '}';
  }
