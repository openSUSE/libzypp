...
inline std::ostream &operator<<(
  std::ostream &str, const zypp::shared_ptr<D> &obj )
{
  if ( obj )
    return str << *obj;
...
template <>
inline std::ostream &operator<<(
  std::ostream &str, const zypp::shared_ptr<void> &obj )
{
  if ( obj )
...
template <class D>
inline std::ostream &operator<<(
  std::ostream &str, const zypp::intrusive_ptr<D> &obj )
{
  if ( obj )
    return str << *obj;
  return str << std::string( "NULL" );
...
struct Shared
{
  ...
  bool unique( const constPtrType &ptr_r ) { return !ptr_r || ptr_r.unique(); }
  bool unique( const PtrType &ptr_r ) { return !ptr_r || ptr_r.unique(); }
...
struct Scoped
{
  ...
  /** Check whether pointer is not shared. */
  bool unique( const constPtrType &ptr_r ) { return true; }
  bool unique( const PtrType &ptr_r ) { return true; }
  /** Return number of references. */
  long use_count( const constPtrType &ptr_r ) const { return ptr_r ? 1 : 0; }
  long use_count( const PtrType &ptr_r ) const { return ptr_r ? 1 : 0; }
};
}
///////////////////////////////////////////////////////////////////
...
struct RW_pointer
{
  ...
  explicit RW_pointer( typename PtrType::element_type *dptr )
    : _dptr( dptr )
  {
  }

  explicit RW_pointer( PtrType dptr )
    : _dptr( dptr )
  {
  }
  ...
  void swap( RW_pointer &rhs ) { _dptr.swap( rhs._dptr ); }

  void swap( PtrType &rhs ) { _dptr.swap( rhs ); }

  explicit operator bool() const { return _dptr.get() != nullptr; }

  const D &operator*() const { return *_dptr; };

  const D *operator->() const { return _dptr.operator->(); }

  const D *get() const { return _dptr.get(); }

  D &operator*() { return *_dptr; }

  D *operator->() { return _dptr.operator->(); }

  D *get() { return _dptr.get(); }

public:
  bool unique() const { return DTraits().unique( _dptr ); }

  long use_count() const { return DTraits().use_count( _dptr ); }

  constPtrType getPtr() const { return _dptr; }

  PtrType getPtr() { return _dptr; }

  constPtrType cgetPtr() { return _dptr; }
...
inline std::ostream &operator<<(
  std::ostream &str, const RW_pointer<D, DPtr> &obj )
{
  if ( obj.get() )
    return str << *obj.get();
  return str << std::string( "NULL" );
...
inline bool operator==(
  const RW_pointer<D, DPtr> &lhs, const RW_pointer<D, DPtr> &rhs )
{
...
template <class D, class DPtr>
inline bool operator==(
  const RW_pointer<D, DPtr> &lhs, const typename DPtr::PtrType &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const typename DPtr::PtrType &lhs, const RW_pointer<D, DPtr> &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const RW_pointer<D, DPtr> &lhs, const typename DPtr::constPtrType &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const typename DPtr::constPtrType &lhs, const RW_pointer<D, DPtr> &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RW_pointer */
...
struct RWCOW_pointer
{
  ...
  explicit RWCOW_pointer( typename PtrType::element_type *dptr )
    : _dptr( dptr )
  {
  }

  explicit RWCOW_pointer( PtrType dptr )
    : _dptr( dptr )
  {
  }
  ...
  void swap( RWCOW_pointer &rhs ) { _dptr.swap( rhs._dptr ); }
...
template <class D, class DPtr>
inline std::ostream &operator<<(
  std::ostream &str, const RWCOW_pointer<D, DPtr> &obj )
{
  if ( obj.get() )
    return str << *obj.get();
  return str << std::string( "NULL" );
...
template <class D, class DPtr>
inline bool operator==(
  const RWCOW_pointer<D, DPtr> &lhs, const RWCOW_pointer<D, DPtr> &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RWCOW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const RWCOW_pointer<D, DPtr> &lhs, const typename DPtr::PtrType &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RWCOW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const typename DPtr::PtrType &lhs, const RWCOW_pointer<D, DPtr> &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RWCOW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const RWCOW_pointer<D, DPtr> &lhs, const typename DPtr::constPtrType &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RWCOW_pointer */
template <class D, class DPtr>
inline bool operator==(
  const typename DPtr::constPtrType &lhs, const RWCOW_pointer<D, DPtr> &rhs )
{
  return ( lhs.get() == rhs.get() );
}
/** \relates RWCOW_pointer */
