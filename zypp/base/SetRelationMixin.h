...
inline std::ostream &operator<<(
  std::ostream &str, const SetCompare::Enum &obj )
{
...
inline std::ostream &operator<<(
  std::ostream &str, const SetRelation::Enum &obj )
{
...
inline bool operator==(
  const SetRelation::Enum &lhs, const SetCompare::Enum &rhs )
{
...
/** \overload */
inline bool operator==(
  const SetCompare::Enum &lhs, const SetRelation::Enum &rhs )
{
  return ( rhs == lhs );
}
/** \overload */
...
inline SetCompare compare(
  const SetRelationMixin<Derived> &src, const SetRelationMixin<Derived> &trg )
{
...
template <class Derived>
inline bool compare( const SetRelationMixin<Derived> &src,
  const SetRelationMixin<Derived> &trg, SetCompare cmp )
{
...
template <class Derived>
inline bool compare( const SetRelationMixin<Derived> &src,
  const SetRelationMixin<Derived> &trg, SetRelation rel )
{
...
#define SETRELATIONMIXIN_DEFINE_COMPARE_BETWEEN( DERIVED_TYPE, OTHER_TYPE )    \
  ...
  inline SetCompare compare(                                                   \
    OTHER_TYPE src, const base::SetRelationMixin<DERIVED_TYPE> &trg )          \
  {                                                                            \
    return DERIVED_TYPE( src ).compare( trg );                                 \
  }                                                                            \
                                                                               \
  inline bool compare( const base::SetRelationMixin<DERIVED_TYPE> &src,        \
    OTHER_TYPE trg, SetCompare cmp )                                           \
  {                                                                            \
    return src.compare( DERIVED_TYPE( trg ), cmp );                            \
  }                                                                            \
  inline bool compare( OTHER_TYPE src,                                         \
    const base::SetRelationMixin<DERIVED_TYPE> &trg, SetCompare cmp )          \
  {                                                                            \
    return DERIVED_TYPE( src ).compare( trg, cmp );                            \
  }                                                                            \
                                                                               \
  inline bool compare( const base::SetRelationMixin<DERIVED_TYPE> &src,        \
    OTHER_TYPE trg, SetRelation rel )                                          \
  {                                                                            \
    return src.compare( DERIVED_TYPE( trg ), rel );                            \
  }                                                                            \
  inline bool compare( OTHER_TYPE src,                                         \
    const base::SetRelationMixin<DERIVED_TYPE> &trg, SetRelation rel )         \
  {                                                                            \
