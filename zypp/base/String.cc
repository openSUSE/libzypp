...
bool strToTrue( const C_Str &str )
{
  ...
  return ( t == "1" || t == "yes" || t == "true" || t == "on" || t == "+" ||
...
{
  std::string t( toLower( str ) );
  return !( t == "0" || t == "no" || t == "false" || t == "off" || t == "-" );
}
...
std::string gsub(
  const std::string &str_r, const std::string &from_r, const std::string &to_r )
{
...
std::string receiveUpTo(
  std::istream &str, const char delim_r, bool returnDelim_r )
{
