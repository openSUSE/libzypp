...
{ /////////////////////////////////////////////////////////////////
  ...
  inline ZYPP_EXPORT std::ostream & operator<<( std::ostream & str, const C_Str & obj )
  ...
  */
  ...
  { /////////////////////////////////////////////////////////////////
     ...
     */
    inline ZYPP_EXPORT std::string asString( const std::string &t )
    { return t; }

    inline ZYPP_EXPORT std::string asString( const char * t )
    { return t; }
    ...
    ZYPP_EXPORT std::string form( const char * format, ... )
     ...
     * the string as well.
    */
    ZYPP_EXPORT std::string strerror( int errno_r );
    ...
    */
    ...
    ZYPP_EXPORT bool strToTrue( const C_Str & str );

    /** Return \c false if str is <tt>0, false, no, off</tt>. */
    ZYPP_EXPORT bool strToFalse( const C_Str & str );
     ...
     */
    ZYPP_EXPORT std::string gsub( const std::string & str_r, const std::string & from_r, const std::string & to_r );

    /** \overload A function is called on demand to compute each replacement value.
     */
    ZYPP_EXPORT std::string gsubFun( const std::string & str_r, const std::string & from_r, function<std::string()> to_r );
     ...
     */
    ZYPP_EXPORT std::string & replaceAll( std::string & str_r, const std::string & from_r, const std::string & to_r );

    /** \overload A function is called on demand to compute each replacement value.
     */
    ZYPP_EXPORT std::string & replaceAllFun( std::string & str_r, const std::string & from_r, function<std::string()> to_r );
    ...
    */
    ...
    template <class _Iterator>
       ...
       */
      ZYPP_EXPORT std::string escape( const C_Str & str_r, const char c = ' ' );
     ...
     * This includes the % character itself, which becomes %25.
     */
    ZYPP_EXPORT std::string hexencode( const C_Str & str_r );
    /** Decode hexencoded %XX sequences. */
    ZYPP_EXPORT std::string hexdecode( const C_Str & str_r );
    //@}
    ///////////////////////////////////////////////////////////////////
     ...
     * \todo improve
    */
    ZYPP_EXPORT std::string toLower( const std::string & s );
    /** \overload */
     ...
     * \todo improve
    */
    ZYPP_EXPORT std::string toUpper( const std::string & s );
    /** \overload */
    ...
    */
    ...
    ZYPP_EXPORT std::string trim( const std::string & s, const Trim trim_r = TRIM );
    ...
    ZYPP_EXPORT std::string stripFirstWord( std::string & line, const bool ltrim_first );

    ZYPP_EXPORT std::string stripLastWord( std::string & line, const bool rtrim_first );

    /** Return stream content up to (but not returning) the next newline.
     * \see \ref receiveUpTo
     */
    ZYPP_EXPORT std::string getline( std::istream & str, bool trim = false );

    /** Return stream content up to (but not returning) the next newline.
     * \see \ref receiveUpTo
     */
    ZYPP_EXPORT std::string getline( std::istream & str, const Trim trim_r );
     ...
     */
    ZYPP_EXPORT std::string receiveUpTo( std::istream & str, const char delim_r, bool returnDelim_r = false );
