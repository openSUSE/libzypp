...
/**
     ...
     */
inline const std::string &asString( const std::string &t ) { return t; }

#ifndef SWIG // Swig treats it as syntax error
inline std::string &&asString( std::string &&t ) { return std::move( t ); }
#endif
...
private:
  void relax()
  {
    ...
    _fmter.exceptions(
      all_error_bits ^ ( too_many_args_bit | too_few_args_bit ) );
  }
};
///////////////////////////////////////////////////////////////////
/** \name String representation of number.
     ...
     **/
//@{
inline std::string numstring( char n, int w = 0 )
{
  return form( "%*hhd", w, n );
}
inline std::string numstring( unsigned char n, int w = 0 )
{
  return form( "%*hhu", w, n );
}
inline std::string numstring( short n, int w = 0 )
{
  return form( "%*hd", w, n );
}
inline std::string numstring( unsigned short n, int w = 0 )
{
  return form( "%*hu", w, n );
}
inline std::string numstring( int n, int w = 0 ) { return form( "%*d", w, n ); }
inline std::string numstring( unsigned n, int w = 0 )
{
  return form( "%*u", w, n );
}
inline std::string numstring( long n, int w = 0 )
{
  return form( "%*ld", w, n );
}
inline std::string numstring( unsigned long n, int w = 0 )
{
  return form( "%*lu", w, n );
}
inline std::string numstring( long long n, int w = 0 )
{
  return form( "%*lld", w, n );
}
inline std::string numstring( unsigned long long n, int w = 0 )
{
  return form( "%*llu", w, n );
}
...
template <>
inline std::string asString( const unsigned char &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const short &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const unsigned short &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const int &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const unsigned &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const long &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const unsigned long &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const long long &t )
{
  return numstring( t );
}
template <>
inline std::string asString( const unsigned long long &t )
{
  return numstring( t );
}
//@}
...
/** \name String representation of number as hex value with leading '0x'.
     ...
     **/
//@{
inline std::string hexstring( char n, int w = 4 )
{
  return form( "%#0*hhx", w, n );
}
inline std::string hexstring( unsigned char n, int w = 4 )
{
  return form( "%#0*hhx", w, n );
}
inline std::string hexstring( short n, int w = 10 )
{
  return form( "%#0*hx", w, n );
}
inline std::string hexstring( unsigned short n, int w = 10 )
{
  return form( "%#0*hx", w, n );
}
inline std::string hexstring( int n, int w = 10 )
{
  return form( "%#0*x", w, n );
}
inline std::string hexstring( unsigned n, int w = 10 )
{
  return form( "%#0*x", w, n );
}
inline std::string hexstring( long n, int w = 10 )
{
  return form( "%#0*lx", w, n );
}
inline std::string hexstring( unsigned long n, int w = 10 )
{
  return form( "%#0*lx", w, n );
}
inline std::string hexstring( long long n, int w = 0 )
{
  return form( "%#0*llx", w, n );
}
inline std::string hexstring( unsigned long long n, int w = 0 )
{
  return form( "%#0*llx", w, n );
}
//@}
...
/** \name String representation of number as octal value with leading '0'.
     ...
     **/
//@{
inline std::string octstring( char n, int w = 4 )
{
  return form( "%#0*hho", w, n );
}
inline std::string octstring( unsigned char n, int w = 4 )
{
  return form( "%#0*hho", w, n );
}
inline std::string octstring( short n, int w = 5 )
{
  return form( "%#0*ho", w, n );
}
inline std::string octstring( unsigned short n, int w = 5 )
{
  return form( "%#0*ho", w, n );
}
inline std::string octstring( int n, int w = 5 )
{
  return form( "%#0*o", w, n );
}
inline std::string octstring( unsigned n, int w = 5 )
{
  return form( "%#0*o", w, n );
}
inline std::string octstring( long n, int w = 5 )
{
  return form( "%#0*lo", w, n );
}
inline std::string octstring( unsigned long n, int w = 5 )
{
  return form( "%#0*lo", w, n );
}
inline std::string octstring( long long n, int w = 0 )
{
  return form( "%#0*llo", w, n );
}
inline std::string octstring( unsigned long long n, int w = 0 )
{
  return form( "%#0*llo", w, n );
}
//@}
...
template <>
inline short strtonum( const C_Str &str )
{
  return ::strtol( str, NULL, 0 );
}
template <>
inline int strtonum( const C_Str &str )
{
  return ::strtol( str, NULL, 0 );
}
template <>
inline long strtonum( const C_Str &str )
{
  return ::strtol( str, NULL, 0 );
}
template <>
inline long long strtonum( const C_Str &str )
{
  return ::strtoll( str, NULL, 0 );
}

template <>
inline unsigned short strtonum( const C_Str &str )
{
  return ::strtoul( str, NULL, 0 );
}
template <>
inline unsigned strtonum( const C_Str &str )
{
  return ::strtoul( str, NULL, 0 );
}
template <>
inline unsigned long strtonum( const C_Str &str )
{
  return ::strtoul( str, NULL, 0 );
}
template <>
inline unsigned long long strtonum( const C_Str &str )
{
...
{
  if ( strToTrue( str ) )
    return ( return_r = true );
  if ( !strToFalse( str ) )
    return ( return_r = false );
  return return_r;
}
...
/**
     ...
     */
std::string gsub( const std::string &str_r, const std::string &from_r,
  const std::string &to_r );

/** \overload A function is called on demand to compute each replacement value.
     */
std::string gsubFun( const std::string &str_r, const std::string &from_r,
...
std::string &replaceAll(
  std::string &str_r, const std::string &from_r, const std::string &to_r );

/** \overload A function is called on demand to compute each replacement value.
     */
std::string &replaceAllFun(
  std::string &str_r, const std::string &from_r, function<std::string()> to_r );
...
/** Enhance readability: insert gaps at regular distance
     ...
     * \endcode
     */
inline std::string gapify(
  std::string inp_r, std::string::size_type gap_r = 1, char gapchar = ' ' )
{
  if ( gap_r && inp_r.size() > gap_r )
  {
    inp_r.reserve( inp_r.size() + ( inp_r.size() - 1 ) / gap_r );
    for ( std::string::size_type pos = gap_r; pos < inp_r.size();
          pos += gap_r + 1 )
...
unsigned split( const C_Str &line_r, TOutputIterator result_r,
...
/** Split \a line_r into words with respect to escape delimeters.
     ...
     */
template <class TOutputIterator>
unsigned splitEscaped( const C_Str &line_r, TOutputIterator result_r,
  const C_Str &sepchars_r = " \t", bool withEmpty = false )
{
  const char *beg = line_r;
  const char *cur = beg;
  unsigned ret = 0;
  ...
  for ( beg = cur; *beg; beg = cur, ++result_r, ++ret )
  {
    ...
    do
    {
      ...
      *cur && ( quoting != Quote::None || !::strchr( sepchars_r, *cur ) ) );
...
/** Split \a line_r into fields.
    ...
    */
template <class TOutputIterator>
unsigned splitFields(
  const C_Str &line_r, TOutputIterator result_r, const C_Str &sepchars_r = ":" )
{
  const char *beg = line_r;
  const char *cur = beg;
  unsigned ret = 0;
...
/** Join strings using separator \a sep_r, quoting or escaping the values.
     ...
     */
template <class TIterator>
std::string joinEscaped(
  TIterator begin, TIterator end, const char sep_r = ' ' )
{
  std::vector<char> buf;
  for ( TIterator iter = begin; iter != end; ++iter )
  {
...
/** Indent by string ["  "] optionally wrap.
       ...
       */
inline std::ostream &printIndented( std::ostream &str,
  const std::string &text_r, const std::string &indent_r = "  ",
...
inline std::ostream &printIndented( std::ostream &str,
  const std::string &text_r, unsigned indent_r, char indentch_r = ' ',
  unsigned maxWitdh_r = 0 )
{
...
inline std::ostream &printIndented( std::ostream &str,
  const std::string &text_r, unsigned indent_r, unsigned maxWitdh_r,
  char indentch_r = ' ' )
{
  return printIndented(
    str, text_r, std::string( indent_r, indentch_r ), maxWitdh_r );
...
/** Prefix lines by string computed by function taking line begin/end [std::string(const char*, const char*)]
       * Prints nothing for an empty string. Asserts a trainling '\n' on the last line.
       */
inline std::ostream &autoPrefix( std::ostream &str, const std::string &text_r,
...
inline std::ostream &autoPrefix0(
  std::ostream &str, const std::string &text_r, function<std::string()> fnc_r )
{
  auto wrap = [&fnc_r](
    const char *, const char * ) -> std::string { return fnc_r(); };
...
inline void appendEscaped(
  std::string &str_r, const C_Str &next_r, const char sep_r = ' ' )
{
  if ( !str_r.empty() )
    str_r += sep_r;
  if ( next_r.empty() )
...
inline std::string ltrim( const std::string &s ) { return trim( s, L_TRIM ); }
inline std::string ltrim( std::string &&s )
{
  return trim( std::move( s ), L_TRIM );
}

inline std::string rtrim( const std::string &s ) { return trim( s, R_TRIM ); }
...
std::string receiveUpTo(
  std::istream &str, const char delim_r, bool returnDelim_r = false );
...
{
  return ( str_r.size() >= suffix_r.size() &&
           ::strncmp( str_r + str_r.size() - suffix_r.size(), suffix_r,
             suffix_r.size() ) == 0 );
}
/** \overload Case insensitive */
...
{
  return ( str_r.size() >= suffix_r.size() &&
           ::strncasecmp( str_r + str_r.size() - suffix_r.size(), suffix_r,
             suffix_r.size() ) == 0 );
}
...
/** \overload Case insensitive */
inline std::string::size_type commonPrefixCI(
  const C_Str &lhs, const C_Str &rhs )
{
  const char *lp = lhs.c_str();
  const char *rp = rhs.c_str();
  std::string::size_type ret = 0;
