...
MediaPlugin::MediaPlugin(
  ...
  : MediaHandler( url_r, attach_point_hint_r, /*path below attachpoint*/ "/",
      /*does_download*/ false )
{
  MIL << "MediaPlugin::MediaPlugin(" << url_r << ", " << attach_point_hint_r
      << ")" << endl;
}
...
void MediaPlugin::getDirInfo( std::list<std::string> &retlist_r,
  const Pathname &dirname_r, bool dots_r ) const
{
}

void MediaPlugin::getDirInfo( filesystem::DirContent &retlist_r,
  const Pathname &dirname_r, bool dots_r ) const
{
}
