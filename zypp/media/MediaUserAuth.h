 ...
 */
class ZYPP_EXPORT CurlAuthData : public AuthData {
public:
  /**
...
ZYPP_EXPORT std::ostream & operator << (std::ostream & str, const AuthData & auth_data);
ZYPP_EXPORT std::ostream & operator << (std::ostream & str, const CurlAuthData & auth_data);
