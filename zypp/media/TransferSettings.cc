...
void TransferSettings::reset() { _impl.reset( new TransferSettings::Impl() ); }
...
std::string TransferSettings::username() const { return _impl->_username; }
...
std::string TransferSettings::password() const { return _impl->_password; }
...
bool TransferSettings::proxyEnabled() const { return _impl->_useproxy; }
...
std::string TransferSettings::proxy() const { return _impl->_proxy; }
...
void TransferSettings::setTimeout( long t ) { _impl->_timeout = t; }

long TransferSettings::timeout() const { return _impl->_timeout; }
...
long TransferSettings::maxSilentTries() const { return _impl->_maxSilentTries; }
...
bool TransferSettings::verifyHostEnabled() const { return _impl->_verify_host; }
...
bool TransferSettings::verifyPeerEnabled() const { return _impl->_verify_peer; }
...
void TransferSettings::setCertificateAuthoritiesPath(
...
std::string TransferSettings::authType() const { return _impl->_authtype; }
