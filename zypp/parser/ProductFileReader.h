...
{ /////////////////////////////////////////////////////////////////
  ...
  { /////////////////////////////////////////////////////////////////
    ...
    */
    ...
    ZYPP_API std::ostream & operator<<( std::ostream & str, const ProductFileData & obj );

    /** \relates  ProductFileData::Upgrade Stream output */
    ZYPP_API std::ostream & operator<<( std::ostream & str, const ProductFileData::Upgrade & obj );
