...
namespace zypp
{
   ...
   * \endcode
   */
  class ZYPP_API ZYPP_INTERNAL_DEPRECATE RepoindexFileReader : private base::NonCopyable
  {
  public:
   /**
    * Callback definition.
  ...
  private:
    using Impl = zyppng::parser::RepoIndexFileReader;
