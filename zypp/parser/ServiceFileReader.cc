...
{ /////////////////////////////////////////////////////////////////
  ...
  { /////////////////////////////////////////////////////////////////
	...
	typedef std::map<std::string,std::pair<std::string,ServiceInfo::RepoState> > RepoStatesMap;
	RepoStatesMap repoStates;	// <repo_NUM,< alias,RepoState >>
	...
	if ( ! repoStates.empty() )
	{
	  ...
	  for_( it, repoStates.begin(), repoStates.end() )
	  {
	    const RepoStatesMap::value_type & el( *it );
