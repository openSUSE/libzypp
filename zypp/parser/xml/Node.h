...
public:
  ...
  explicit operator bool() const { return _reader; }

public:
  /** Provides the number of attributes of the current node. */
  int attributeCount() const { return xmlTextReaderAttributeCount( _reader ); }

  /** The base URI of the node. */
  XmlString baseUri() const { return xmlTextReaderConstBaseUri( _reader ); }
  ...
  int depth() const { return xmlTextReaderDepth( _reader ); }

  /** Determine the encoding of the document being read. */
  XmlString encoding() const { return xmlTextReaderConstEncoding( _reader ); }
  ...
  {
    return XmlString(
      xmlTextReaderGetAttributeNo( _reader, no_r ), XmlString::FREE );
  }

  /** Whether the node has attributes. */
  int hasAttributes() const { return xmlTextReaderHasAttributes( _reader ); }

  /** Whether the node can have a text value. */
  int hasValue() const { return xmlTextReaderHasValue( _reader ); }
  ...
  int isDefault() const { return xmlTextReaderIsDefault( _reader ); }

  /** Check if the current node is empty. */
  int isEmptyElement() const { return xmlTextReaderIsEmptyElement( _reader ); }
  ...
  int lineNumber() const { return xmlTextReaderGetParserLineNumber( _reader ); }

  /** The local name of the node. */
  XmlString localName() const { return xmlTextReaderConstLocalName( _reader ); }

  /** The qualified name of the node, equal to Prefix :LocalName. */
  XmlString name() const { return xmlTextReaderConstName( _reader ); }
  ...
  XmlString prefix() const { return xmlTextReaderConstPrefix( _reader ); }

  /** The quotation mark character used to enclose the value of an attribute.
       * \return \c " or \c ' or -1 in case of error. */
  int quoteChar() const { return xmlTextReaderQuoteChar( _reader ); }
  ...
  XmlString value() const { return xmlTextReaderConstValue( _reader ); }
  ...
  XmlString xmlLang() const { return xmlTextReaderConstXmlLang( _reader ); }
