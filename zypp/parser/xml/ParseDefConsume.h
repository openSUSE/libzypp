...
struct Assigner : public Assigner<void>
{
  ...
  virtual void assign( const char *text_r ) { *_value = Tp( text_r ); }
...
//@{
template <>
inline void Assigner<short>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<int>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<long>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<long long>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<unsigned short>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<unsigned>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<unsigned long>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<unsigned long long>::assign( const char *text_r )
{
  str::strtonum( text_r, *_value );
}
template <>
inline void Assigner<bool>::assign( const char *text_r )
{
  str::strToBoolNodefault( text_r, *_value );
}
//@}
...
{
  /** Extend \ref Consumer. */
  void add( const AssignerRef &assigner_r ) { _text.push_back( assigner_r ); }
  ...
  void prenotify( function<void( const Node & )> pre_r ) { _pre = pre_r; }

  /** Set post notification callback. */
  void postnotify( function<void( const Node & )> post_r ) { _post = post_r; }
...
private:
  ...
  {
    if ( value_r )
      for_( it, vec_r.begin(), vec_r.end() )( *it )->assign( value_r );
  }
...
struct Builder
{
  ...
  operator shared_ptr<ParseDefConsume>() const { return _ptr; }
