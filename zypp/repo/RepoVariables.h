...
namespace zypp
{
  ...
  namespace repo
  {
     ...
     * \endcode
     */
    struct ZYPP_EXPORT RepoVariablesStringReplacer : public std::unary_function<const std::string &, std::string>
    {
     ...
     */
    struct ZYPP_EXPORT RepoVariablesUrlReplacer : public std::unary_function<const Url &, Url>
    {
