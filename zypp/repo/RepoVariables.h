...
typedef base::ValueTransform<std::string, repo::RepoVariablesStringReplacer>
  RepoVariablesReplacedString;

/** \relates RepoVariablesStringReplacer Helper managing repo variables replaced string lists */
typedef base::ContainerTransform<std::list<std::string>,
...
typedef base::ValueTransform<Url, repo::RepoVariablesUrlReplacer>
  RepoVariablesReplacedUrl;

/** \relates RepoVariablesUrlReplacer Helper managing repo variables replaced url lists */
typedef base::ContainerTransform<std::list<Url>, repo::RepoVariablesUrlReplacer>
