...
public:
  ...
  /** \overload SolvAttr within sub-structure \a parent_r. */
  LookupAttr( SolvAttr attr_r, SolvAttr parent_r, Repository repo_r,
    Location = SOLV_ATTR );
...
public:
  ...
  void setPool() { LookupAttr::setPool( REPO_ATTR ); }
...
public:
  ...
  void reset() { DIWrap().swap( *this ); }
public:
  /** Evaluate in a boolean context <tt>( _dip != NULL )</tt>. */
  explicit operator bool() const { return _dip; }
...
public:
  ...
  detail::IdType id() const { return idStr().id(); }
...
private:
  ...
  template <class OtherDerived, class OtherIterator, class V, class C, class R,
    class D>
  bool equal( const boost::iterator_adaptor<OtherDerived, OtherIterator, V, C,
    R, D> &rhs ) const
  {
...
public:
  /** Expert backdoor. */
  detail::CDataiterator *get() const { return _dip.get(); }
private:
  detail::DIWrap _dip;
};
///////////////////////////////////////////////////////////////////
...
//@{
template <>
inline int LookupAttr::iterator::asType<int>() const
{
  return asInt();
}
template <>
inline unsigned LookupAttr::iterator::asType<unsigned>() const
{
  return asUnsigned();
}
template <>
...
template <>
inline bool LookupAttr::iterator::asType<bool>() const
{
  return asBool();
}
template <>
inline const char *LookupAttr::iterator::asType<const char *>() const
{
  return c_str();
}
template <>
inline std::string LookupAttr::iterator::asType<std::string>() const
{
  return asString();
}
template <>
inline IdString LookupAttr::iterator::asType<IdString>() const
{
  return idStr();
}
template <>
