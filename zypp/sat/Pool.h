...
public:
  /** Singleton ctor. */
  static Pool instance() { return Pool(); }
...
public:
  ...
  filter_iterator<TFilter, SolvableIterator> filterBegin(
  ...
  template <class TFilter>
  filter_iterator<TFilter, SolvableIterator> filterEnd(
    const TFilter &filter_r ) const
  {
