...
/** Solvable set wrapper to allow adding additional convenience iterators.
     */
class SolvableSet : public SolvIterMixin<SolvableSet,
                      std::unordered_set<Solvable>::const_iterator>
{
...
public:
  ...
  bool empty() const { return _pimpl->empty(); }
...
public:
  /** The set. */
  Container &get() { return *_pimpl; }

  /** The set. */
  const Container &get() const { return *_pimpl; }
