...
public:
  ...
  Capability cap() const { return _pimpl->_cap; }

  /** Kind of that capability */
  Dep capKind() const { return _pimpl->_capKind; }

  /** Item which has triggered this selection */
  PoolItem item() const { return _pimpl->_item; }

  /** This item has triggered the installation (Not already fullfilled requierement only). */
  bool initialInstallation() const { return _pimpl->_initialInstallation; }
