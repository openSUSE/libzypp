...
rpm::RpmInstallReport::Action RpmInstallPackageReceiver::problem(
  Exception &excpt_r )
{
  rpm::InstallResolvableReport::Action user = _report->problem( _resolvable,
    rpm::InstallResolvableReport::INVALID, excpt_r.asUserHistory(), _level );
...
{
  _report->finish(
    _resolvable, rpm::InstallResolvableReport::NO_ERROR, _finishInfo, _level );
}
...
{
  _report->finish(
    _resolvable, rpm::InstallResolvableReport::INVALID, std::string(), _level );
}

void RpmInstallPackageReceiver::tryLevel(
  target::rpm::InstallResolvableReport::RpmLevel level_r )
{
  _level = level_r;
}
...
rpm::RpmRemoveReport::Action RpmRemovePackageReceiver::problem(
  Exception &excpt_r )
{
  rpm::RemoveResolvableReport::Action user = _report->problem( _resolvable,
    rpm::RemoveResolvableReport::INVALID, excpt_r.asUserHistory() );
...
void RpmRemovePackageReceiver::finish()
{
  ...
  _report->finish(
    _resolvable, rpm::RemoveResolvableReport::NO_ERROR, _finishInfo );
}
...
{
  _report->finish(
    _resolvable, rpm::RemoveResolvableReport::INVALID, std::string() );
}
