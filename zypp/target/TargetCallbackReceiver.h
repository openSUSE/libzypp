  ...
  { /////////////////////////////////////////////////////////////////
        ...
        : public callback::ReceiveReport<rpm::RpmInstallReport>
    {
      ...
      public:
        ...
        /** Start the operation */
        virtual void start( const Pathname & name ) override;
         ...
         */
        virtual bool progress( unsigned percent ) override;

        /** inform user about a problem */
        virtual rpm::RpmInstallReport::Action problem( Exception & excpt_r ) override;

        /** Additional rpm output to be reported in \ref finish in case of success. */
        virtual void finishInfo( const std::string & info_r ) override;

        /** Finish operation in case of success */
        virtual void finish() override;

        /** Finish operatin in case of fail, report fail exception */
        virtual void finish( Exception & excpt_r ) override;
    };
        ...
        : public callback::ReceiveReport<rpm::RpmRemoveReport>
    {
      ...
      public:
        ...
        /** inform user about a problem */
        virtual rpm::RpmRemoveReport::Action problem( Exception & excpt_r ) override;
