...
private:
  ...
  bool solvfilesPathIsTemp() const { return !_tmpSolvfilesPath.empty(); }
...
public:
  ...
  Pathname root() const { return _root; }

  /** The directory to store things. */
  Pathname home() const { return home( _root ); }
  ...
  LocaleSet requestedLocales() const { return _requestedLocalesFile.locales(); }
  /** \overload */
