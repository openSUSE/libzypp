...
public:
  ...
  /**
         ...
         * \return Vector with device UDI's.
         */
  std::vector<std::string> findDevicesByCapability(
    const std::string &capability ) const;

  bool getDevicePropertyBool(
    const std::string &udi, const std::string &key ) const;

  int32_t getDevicePropertyInt32(
    const std::string &udi, const std::string &key ) const;

  uint64_t getDevicePropertyUInt64(
    const std::string &udi, const std::string &key ) const;

  double getDevicePropertyDouble(
    const std::string &udi, const std::string &key ) const;

  std::string getDevicePropertyString(
    const std::string &udi, const std::string &key ) const;

  void setDevicePropertyBool(
  ...
  void setDevicePropertyDouble(
    const std::string &udi, const std::string &key, double value );

  void setDevicePropertyString(
