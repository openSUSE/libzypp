...
public:
  ...
  static Ptr get( IdString ident_r ) { return get( pool::ByIdent( ident_r ) ); }
  ...
  static Ptr get( const PoolItem &pi_r ) { return get( pi_r.satSolvable() ); }
  //@}
...
public:
  ...
  /** Arrange the specified candidate (out of available objects) to be on system after commit.
       ...
       */
  bool setOnSystem( const PoolItem &newCandidate_r,
    ResStatus::TransactByValue causer_r = ResStatus::USER );
...
public:
  ...
  bool hasObject() const { return ( !installedEmpty() ) || candidateObj(); }

  /** True if installed object is present. */
  bool hasInstalledObj() const { return !installedEmpty(); }

  /** True if candidate object is present. */
  bool hasCandidateObj() const { return bool( candidateObj() ); }
  ...
  /** Select a specific available item for installation.
       */
  bool pickInstall( const PoolItem &pi_r,
    ResStatus::TransactByValue causer_r = ResStatus::USER,
    bool yesno_r = true );

  /** Deselect a specific available item from installation.
      */
  bool pickNoInstall( const PoolItem &pi_r,
    ResStatus::TransactByValue causer_r = ResStatus::USER )
  {
  ...
  /** Select a specific installed item for deletion.
       */
  bool pickDelete( const PoolItem &pi_r,
    ResStatus::TransactByValue causer_r = ResStatus::USER,
    bool yesno_r = true );

  /** Deselect a specific installed item from deletion.
       */
  bool pickNoDelete( const PoolItem &pi_r,
    ResStatus::TransactByValue causer_r = ResStatus::USER )
  {
  ...
  bool setPickStatus( const PoolItem &pi_r, Status state_r,
    ResStatus::TransactByValue causer_r = ResStatus::USER );
  //@}
...
public:
  ...
  bool unmodified() const { return fate() == UNMODIFIED; }
  ...
  bool toModify() const { return fate() != UNMODIFIED; }

  /** True if to delete */
  bool toDelete() const { return fate() == TO_DELETE; }

  /** True if to install */
  bool toInstall() const { return fate() == TO_INSTALL; }
  ...
  /** */
  bool setFate(
    Fate fate_r, ResStatus::TransactByValue causer_r = ResStatus::USER );
...
public:
  ...
  /**
       ...
       */
  bool setStatus(
    Status state_r, ResStatus::TransactByValue causer_r = ResStatus::USER );
