...
struct ViewOption
{
  ...
  /**
       ...
       */
  friend inline ViewOption operator+( const ViewOption &l, const ViewOption &r )
  {
  ...
  /**
       ...
       */
  inline ViewOption &operator=( const ViewOption &o )
  {
    opt = o.opt;
    return *this;
  }
  ...
  /**
       ...
       */
  inline bool has( const ViewOption &o ) const { return o.opt & opt; }
...
public:
  ...
  /**
       ...
       */
  UrlBase( const std::string &scheme, const std::string &authority,
  ...
  /**
       ...
       *         contains an invalid character.
       */
  virtual void init( const std::string &scheme, const std::string &authority,
    const std::string &pathdata, const std::string &querystr,
    const std::string &fragment );
  ...
  /**
       ...
       *         would contain a '\\0' character.
       */
  virtual std::string getPathParam(
  ...
  /**
       ...
       *         would contain a '\\0' character.
       */
  virtual std::string getQueryParam(
    const std::string &param, EEncoding eflag ) const;
...
protected:
  /**
       ...
       */
  virtual std::string cleanupPathName(
