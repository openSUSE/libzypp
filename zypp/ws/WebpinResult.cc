...
inline std::ostream &operator<<(
  std::ostream &str, const WebpinResult::Impl &obj )
{
...
std::string WebpinResult::name() const { return _pimpl->name; }

zypp::Url WebpinResult::repositoryUrl() const { return _pimpl->repourl; }
...
std::string WebpinResult::distribution() const { return _pimpl->distro; }
...
std::string WebpinResult::summary() const { return _pimpl->summary; }
...
int WebpinResult::priority() const { return _pimpl->priority; }
...
Edition WebpinResult::edition() const { return _pimpl->edition; }
...
CheckSum WebpinResult::checksum() const { return _pimpl->checksum; }
