  ...
  { //////////////////////////////////////////////////////////////////
    ...
    { ////////////////////////////////////////////////////////////////
      ...
      struct ManagedMedia
      {
        ...
        static ManagedMedia makeManagedMedia ( const MirroredOrigin &origin_r, const Pathname &preferred_attach_point, const MediaVerifierRef &v )
        {
    ...
    {
      return open({MirroredOrigin(url)}, preferred_attach_point );
    }

    MediaAccessId MediaManager::open(const MirroredOrigin &origin_r, const Pathname &preferred_attach_point)
    {
      // create new access handler for it
      MediaVerifierRef verifier( new NoVerifier());
      ManagedMedia tmp = ManagedMedia::makeManagedMedia( origin_r, preferred_attach_point, verifier );
