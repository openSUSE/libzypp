...
export module zyppng:sat_capability;
...
export namespace zyppng::sat
{
  ...
  class Capability
  {
    ...
    public:
      ...
      */
       ...
       * \note Compile-time check in pool.cc
       */
      enum CapRel
      {
        CAP_AND       = 16, ///< \c and
  ...
  /**
   * \class CapDetail
   * \brief Helper providing more detailed information about a \ref Capability.
   *
...
export ZYPP_DEFINE_ID_HASHABLE( ::zyppng::sat::Capability )
