...
export module zyppng:sat_components_architecturecomponent;
...
export namespace zyppng::sat {
  ...
  class ArchitectureComponent : public IPoolComponent {
    public:
      ...
      using ArchitectureProvider = std::function<Arch()>;
      ...
      Arch arch() const
      { return _provider ? _provider() : Arch::detectSystemArchitecture(); }
