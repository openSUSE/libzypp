...
export module zyppng:sat_components_poolcomponents;

import :sat_poolconstants;

// Forward declarations with export linkage — match the definitions in
// :sat_pool and :sat_preparedpool to keep linkage consistent across the
// partitions that pull these forwards in.
export namespace zyppng::sat {
  class Pool;
  class PreparedPool;
}

// Module-purview-only — internal shared base, not exported to consumers.
namespace zyppng::sat::detail {
  ...
  public:
    ...
    virtual void checkDirty   ( ::zyppng::sat::Pool & )                                       {}
    /** React to pool invalidation — clear internal caches. */
    virtual void onInvalidate ( ::zyppng::sat::Pool &, ::zyppng::sat::PoolInvalidation )      {}
    virtual void onRepoAdded  ( ::zyppng::sat::Pool &, ::zyppng::sat::detail::RepoIdType )    {}
    virtual void onRepoRemoved( ::zyppng::sat::Pool &, ::zyppng::sat::detail::RepoIdType )    {}
    virtual void onReset      ( ::zyppng::sat::Pool & )                                       {}
