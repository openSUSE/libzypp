...
// libsolv dataiterator API — needed by DIWrap and LookupAttr::iterator impl
#include <zypp/ng/sat/solvincludes.h>

module zyppng;

import :sat_pool;
import :sat_lookupattr;  // LookupAttr, StrMatcher, Location declarations
import :idstringtype;
...
namespace zyppng::sat
{
    ...
    LookupAttr::iterator LookupAttrValue::subFind( std::string_view attrname_r ) const
    {
      if ( attrname_r.empty() )
        return subBegin();
