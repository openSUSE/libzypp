...
export module zyppng:sat_lookupattr;
...
export namespace zyppng::sat
{
     ...
     * \code
     * // look for a repo attribute in the pool:
     * sat::LookupAttr     p( pool, sat::SolvAttr::repositoryAddedFileProvides, sat::LookupAttr::REPO_ATTR );
     *
    ...
    namespace detail
    {
      ...
      class DIWrap
      {
        public:
          ...
          {}
          /** Initializes */
          DIWrap( detail::CPool * pool, RepoIdType repoId_r, SolvableIdType solvId_r, IdType attrId_r,
        ...
        public:
          ...
          detail::CPool * pool()               const  { return _pool; }
    ...
    class LookupAttrValue
    {
      ...
      public:
         ...
         */
        LookupAttr::iterator subFind( std::string_view attrname_r ) const;
        //@}
