...
// Pathname kept: used in inline function bodies (construction, comparison,
// .c_str()) — full definition required here, not just a forward declaration.
#include <zypp-core/Pathname.h>
#include <zypp/ng/sat/solvincludes.h>  // pool_get_rootdir, pool_set_rootdir, pool_parserpmrichdep

export module zyppng:sat_pool;
...
import :sat_components_poolcomponents; // base interface only — concrete components wired by Context
import :base_serialnumber;
