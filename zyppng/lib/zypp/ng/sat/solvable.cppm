...
// Module-purview-only — pool routing template specialisations, not exported.
namespace zyppng::sat::detail {
  template<> ::zyppng::sat::Pool &       poolFromType( ::zyppng::sat::Solvable & );
  template<> const ::zyppng::sat::Pool & poolFromType( const ::zyppng::sat::Solvable & );
} // namespace zyppng::sat::detail
...
// Module-purview-only — internal iterators and conversion traits, not exported.
namespace zyppng::sat::detail
{
      ///////////////////////////////////////////////////////////////////
...
export ZYPP_DEFINE_ID_HASHABLE( ::zyppng::sat::Solvable )
