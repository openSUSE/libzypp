...
// InputStream — const-ref param in parseFrom().
#include <zypp-core/base/inputstream.h>

export module zyppng:sat_solvablespec;
...
export namespace zyppng::sat {
  ...
  public:
    ...
    EvaluatedSolvableSpec( EvaluatedSolvableSpec && ) noexcept    = default;
    EvaluatedSolvableSpec & operator=( const EvaluatedSolvableSpec & )     = default;
    EvaluatedSolvableSpec & operator=( EvaluatedSolvableSpec && ) noexcept = default;
